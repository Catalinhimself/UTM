...
def readAdjacencyList():
    ...
    while True:
        ...
        print("dati varful initial ( poate fi orice numar pozitiv) se recomanda sa fie",
              n, " :")
        e = input()
        if e == "q":
            break
        ...
        while True:
            ...
            print("dati un element din lista de adiacenta pentru varful initial", e)
            a = input()
            if a == "n" or a == "q":
                break
            G[e].append(a)
...
def main():
    ...
    while True:
        ...
        if o == "r":
            ...
            incidenceMatrix, U, X = listToIncidence(G)
            adjacencyMatrix, X = incidenceToAdjacency(incidenceMatrix, U, X)
            # convertirea in celelalte tipuri de matrice
        if o == "i":
            incidenceMatrix, U, X = readIncidenceMatrix()
            # convertirea in celelalte tipuri de matrice
            adjacencyMatrix, X = incidenceToAdjacency(incidenceMatrix, U, X)
            G = adjacencyToList(adjacencyMatrix, X)
            # convertirea in celelalte tipuri de matrice
            print(incidenceMatrix)
            drawList(G)
        if o == "a":
            adjacencyMatrix, X = readAdjacencyMatrix()
            # convertirea in celelalte tipuri de matrice
            G = adjacencyToList(adjacencyMatrix, X)
            incidenceMatrix, U, X = listToIncidence(G)
            # convertirea in celelalte tipuri de matrice
